...
$data_attributes = array(
    ...
    'sphere-size-tablet'     => $attributes['sphereSizeTablet'] ?? 200,
    'sphere-size-mobile'     => $attributes['sphereSizeMobile'] ?? 150,
    'sphere-size-rem-tablet' => $attributes['sphereSizeRemTablet'] ?? 10,
    'sphere-size-rem-mobile' => $attributes['sphereSizeRemMobile'] ?? 8,
    'breakpoint-tablet'      => $attributes['breakpointTablet'] ?? 1024,
    'breakpoint-mobile'      => $attributes['breakpointMobile'] ?? 768,
